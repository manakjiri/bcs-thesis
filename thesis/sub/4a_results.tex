...
\begin{figure}[p]
    \centering
    \subfloat[Continuous receive with transmit in the middle]{\includegraphics[width=.9\textwidth]{fig/rf-transmit-250khz.png}} \hfil
    \subfloat[Idle, transmit, receive acknowledge]{\includegraphics[width=.9\textwidth]{fig/rf-power.png}}
