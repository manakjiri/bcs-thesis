...
\begin{equation}
    C = \dfrac{\epsilon S}{d}
\end{equation}
where the surface area $S$ and distance between the electrodes $d$ are constant, the capacitance is proportional to the dielectric permittivity $\epsilon$. The sensor measures this capacitance, and through calibration, it is possible to relate the capacitance values to specific soil moisture levels.
