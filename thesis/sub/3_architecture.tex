...
Solderable PCB modules are a standard way of integrating existing solutions into custom ones. Modules providing wireless connectivity in particular are very common.

\begin{figure}[htb]
    \centering
    \subfloat[Omega 2S]{\includegraphics[width=.3\textwidth]{img/Omega2S.jpg}}
    \subfloat[RN4871]{\includegraphics[width=.3\textwidth]{img/rn4871.jpg}}
    \subfloat[MAX F10s]{\includegraphics[width=.3\textwidth]{img/max-f10s.png}}
...
The manufacturer also offers a development board, the NUCLEO-WL55JC and a plethora of reference designs, the STDES-WL5xxxxx series. One of these designs, the STDES-WL5U4ILH, overlaps well with our requirements.

\begin{figure}[htb]
    \centering
    \subfloat[NUCLEO-WL55JC]{\includegraphics[width=.45\textwidth]{img/nucleo-wl55jc.jpg}}
    \subfloat[STDES-WL5U4ILH]{\includegraphics[width=.45\textwidth]{img/STDES-WL5U4ILH.jpg}}
