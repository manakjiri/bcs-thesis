...
\subsection{\label{section:mcu} MCU}
...
\begin{figure}
    \centering
    \subfloat[\label{fig:nucleo} NUCLEO-WL55JC]{\includegraphics[width=.45\textwidth]{img/nucleo-wl55jc.jpg}}
    \subfloat[\label{fig:reference-design} STDES-WL5U4ILH]{\includegraphics[width=.45\textwidth]{img/STDES-WL5U4ILH.jpg}}
